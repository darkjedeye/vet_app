	...
	a.extend(a.jqx._jqxComboBox.prototype, {
		...
		render: function () {
			...
			this.propertyChangeMap.disabled = function (e, o, n, p) {
				...
				e.input.attr("disabled", m.disabled)
			};
			if (this.disabled) {
		...
		getSelectedItem: function () {
			return this.getVisibleItem(this.selectedIndex)
		},
		...
		doMultiSelect: function (c) {
			...
			this.addHandler(g.find(".jqx-icon-close"), d, function (m) {
				var n = a(m.target).parent().parent().find("a").attr("data-value");
				var l = e.getItemByValue(n);
				if (l) {
					e.listBox.selectedValue = null;
					var i = e.selectedItems.indexOf(n);
					if (i >= 0) {
						e.selectedItems.splice(i, 1);
						e._selectedItems.splice(i, 1);
						e._raiseEvent("3", {
							index: l.index,
							type: "mouse",
							item: l
