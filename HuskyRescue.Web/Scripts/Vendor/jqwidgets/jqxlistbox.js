...
(function (a) {
	...
	a.extend(a.jqx._jqxListBox.prototype, {
		...
		render: function () {
			...
			this.vScrollBar = f.jqxScrollBar({
				_initialLayout: true,
				vertical: true,
				rtl: this.rtl,
				theme: this.theme,
					...
					if (this.checkboxes && this.host.jqxCheckBox && !w.isGroup) {
						...
						if (F) {
							if (t != w.checked) {
								...
								e.jqxCheckBox({
									disabled: this.disabled || w.disabled
								})
							}
						}
					} else {
		...
		_arrange: function (n) {
			...
			if ((this.vScrollBar[0].style.visibility != "hidden") && (this.hScrollBar[0].style.visibility != "hidden")) {
				...
				this.bottomRight.css({
					left: 1 + parseInt(this.vScrollBar[0].style.left),
					top: 1 + parseInt(this.hScrollBar[0].style.top)
				});
				if (this.rtl) {
					this.bottomRight.css({
						left: 0
			...
			if (this.rtl) {
				...
				this.hScrollBar.css({
					left: this.vScrollBar.width() + 2 + "px"
				});
				if (this.vScrollBar[0].style.visibility != "hidden") {
