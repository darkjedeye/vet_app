...
using HuskyRescue.Core.ViewModel.Accounts.Admin;
...
using ApplicationUserManager = HuskyRescue.Core.Service.Accounts.ApplicationUserManager;

namespace HuskyRescue.Web.Controllers
{
	[Authorize(Roles = "Administrator")]
	public class AccountUsersManageController : Controller
    {
        public AccountUsersManageController()
        {
        }

		public AccountUsersManageController(ApplicationUserManager userManager, ApplicationRoleManager roleManager)
        {
