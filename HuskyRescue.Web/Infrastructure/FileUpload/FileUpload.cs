...
namespace HuskyRescue.Web.Infrastructure.FileUpload
{
    ...
    public class FineUpload
    {
        ...
        public class ModelBinder : IModelBinder
        {
            public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
            {
				...
				var xContentType = request.Headers["X-Mime-Type"];
                ...
                var upload = new FineUpload
                {
					...
					ContentType = formUpload ? request.Files[0].ContentType : xContentType
                };
